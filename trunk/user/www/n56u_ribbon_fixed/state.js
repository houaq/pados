...
tabtitle[3] = new Array("", "<#menu5_3_1#>", "<#nenu5_3_2#>", "<#menu5_3_3#>", "<#menu5_3_4#>", "<#menu5_3_5#>", "<#menu5_3_6#>");
tabtitle[4] = new Array("", "<#menu5_5_1#>", "<#menu5_5_5#>", "<#menu5_5_2#>", "<#menu5_5_3#>", "<#menu5_5_4#>");
tabtitle[5] = new Array("", "<#menu5_4_3#>", "<#menu5_4_1#>", "<#menu5_4_2#>", "<#menu5_4_5#>");
tabtitle[6] = new Array("", "<#menu5_6_2#>", "<#menu5_6_5#>", "<#menu5_6_1#>", "<#menu5_6_3#>", "<#menu5_6_4#>", "<#menu5_6_6#>", "<#menu5_6_7#>");
...
//加入扩展设置
tabtitle[10] = new Array("", "<#menu5_4_6#>", "<#menu5_13_2#>", "<#menu5_13_4#>", "<#menu5_13_5#>", "<#menu5_13_6#>", "<#menu5_13_7#>", "<#menu5_13_8#>","<#menu5_13_9#>","<#menu5_13_10#>");
...
tablink[3] = new Array("", "Advanced_WAN_Content.asp", "Advanced_Modem_others.asp","Advanced_IPv6_Content.asp", "Advanced_VirtualServer_Content.asp", "Advanced_Exposed_Content.asp", "Advanced_DDNS_Content.asp");
...
tablink[5] = new Array("", "Advanced_AiDisk_others.asp", "Advanced_AiDisk_samba.asp", "Advanced_AiDisk_ftp.asp", "Advanced_Printer_others.asp");
tablink[6] = new Array("", "Advanced_System_Content.asp", "Advanced_Services_Content.asp", "Advanced_OperationMode_Content.asp", "Advanced_FirmwareUpgrade_Content.asp", "Advanced_SettingBackup_Content.asp", "Advanced_Console_Content.asp", "Advanced_Console_Content2.asp");
...
//扩展设置菜单
tablink[10] = new Array("", "Advanced_xunlei.asp", "Advanced_adbyby.asp", "Advanced_kms.asp", "Advanced_dnsq.asp", "aria.asp", "ser2net.asp", "mbusd.asp","devman.asp" ,"frp.asp" );
//Level 2 Menu
