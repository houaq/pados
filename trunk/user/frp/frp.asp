...
//	if(validForm()){
		...
		document.form.current_page.value = "/frp.asp";
...
<div class="wrapper">
    ...
    <input type="hidden" name="current_page" value="frp.asp">
                                    ...
                                    <table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
                                        ...
                                        <tr id="frp_script" colspan="4">
                                            <td colspan="4" style="border-top: 0 none;">
                                                ...
                                                <div id="script12">
                                                    <textarea rows="20" wrap="off" spellcheck="false" maxlength="18192" class="span12" name="scripts.frp_script.sh" style="font-family:'Courier New'; font-size:12px;"><% nvram_dump("scripts.frp_script.sh",""); %></textarea>
                                                </div>
                                            </td>
                                        </tr>                                        
                                        <tr>
