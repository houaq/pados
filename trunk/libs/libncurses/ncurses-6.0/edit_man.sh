...
TERMINFO="/home/houaq/openwrt/my-n56u/trunk/stage/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f /home/houaq/openwrt/my-n56u/trunk/libs/libncurses/ncurses-6.0/man_alias.sed ; then
cat >>/home/houaq/openwrt/my-n56u/trunk/libs/libncurses/ncurses-6.0/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/houaq/openwrt/my-n56u/trunk/libs/libncurses/ncurses-6.0/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/houaq/openwrt/my-n56u/trunk/libs/libncurses/ncurses-6.0/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	...
	sed	-f /home/houaq/openwrt/my-n56u/trunk/libs/libncurses/ncurses-6.0/man_alias.sed \
		< $i >$TMP
